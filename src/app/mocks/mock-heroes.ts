...
export const HEROES: HeroInterface[] = [
  ...
  { id: 6, name: 'Star-Lord', hero: true, alter: 'Peter Quill', bio: 'Leader of the Guardians of the Galaxy', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQE0LA_eDLpuc6dDywoA_Jh8kX2CXUnqBxjmRwyijfWWYk49vlzDZepUf0'},
  { id: 7, name: 'Lex Luthor', hero: false, alter: 'Lex Luthor', bio: 'Bald and rich', img: 'https://vignette.wikia.nocookie.net/thelastson/images/2/26/Lex_Luthor.jpg/revision/latest?cb=20120506094752' },
  { id: 8, name: 'Thor', hero: true, alter: 'Thor', bio: 'Has a hammer', img: 'https://i.stack.imgur.com/BVQ7t.jpg' }
];
